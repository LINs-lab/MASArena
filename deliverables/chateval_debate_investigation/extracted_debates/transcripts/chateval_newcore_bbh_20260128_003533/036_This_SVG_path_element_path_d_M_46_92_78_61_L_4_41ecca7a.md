...
This SVG path element <path d="M 46.92,78.61 L 46.94,45.83"/> draws a Options: (A) circle (B) heptagon (C) hexagon (D) kite (E) line (F) octagon (G) pentagon (H) rectangle (I) sector (J) triangle
