...
Which sentence has the correct adjective order: Options: (A) terrible tiny new square Egyptian typing sock (B) new typing square Egyptian tiny terrible sock
