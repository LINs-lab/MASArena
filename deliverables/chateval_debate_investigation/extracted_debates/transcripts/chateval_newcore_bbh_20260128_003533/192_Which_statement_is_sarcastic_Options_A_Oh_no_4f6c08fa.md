...
Which statement is sarcastic? Options: (A) Oh no the cleats with the new spikes didn't solve the problem? (B) Oh no the cleats with the new spikes didn't solve every problem?
