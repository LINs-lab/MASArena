#!/bin/bash
# Run LLM Debate on GAIA validation level-2.
#
# Usage:
#   ./scripts/run_llm_debate_gaia_level2.sh
#   LIMIT=2 CONCURRENCY=2 MODEL_NAME=qwen3-32b ./scripts/run_llm_debate_gaia_level2.sh
...
LOG_FILE="${LOG_FILE:-$LOG_DIR/llm_debate_gaia_level2_${MODEL_NAME}_${TIMESTAMP}.log}"
...
echo "====================================================="
echo "Running LLM Debate GAIA validation level 2"
