#!/bin/bash
# Run LLM Debate on GAIA validation level-1 samples with glm-5.
#
# Usage:
#   ./scripts/run_llm_debate_gaia_level1_glm-5.sh
#   LIMIT=2 CONCURRENCY=1 ./scripts/run_llm_debate_gaia_level1_glm-5.sh
...
LOG_FILE="${LOG_FILE:-$LOG_DIR/llm_debate_gaia_level1_glm-5_${TIMESTAMP}.log}"
