...
for LEVEL in 1 2 3; do
  DATA_FILE="data/gaia_test_level${LEVEL}.jsonl"
  ...
  LOG_FILE="logs/level${LEVEL}/${MODEL_NAME}_${AGENT_SYSTEM}_baseline_test_level${LEVEL}_${TIMESTAMP}.log"
  ...
  echo "Started baseline test for Level ${LEVEL} in background. Logs at $LOG_FILE"
  echo "====================================================="
